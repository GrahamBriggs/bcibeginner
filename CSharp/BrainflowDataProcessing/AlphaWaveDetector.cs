...
namespace BrainflowDataProcessing
{
    public class AlphaWaveDetector
    {
        ...
        //  Delegates
        public GetOpenBciCyton8BandPowerDelegate GetBandPower;
                ...
                while ( ! cancelToken.IsCancellationRequested)
                {
                    try
                    {
                        ...
                        if (sw.ElapsedMilliseconds > PeriodMilliseconds)
                        {
                            ...
                            {
                                if ((band10.ExgCh6 / band12.ExgCh6 < AlphaThresholdFalling) && (band10.ExgCh7 / band12.ExgCh7 < AlphaThresholdFalling))
                                {
                            ...
                            else if ((band10.ExgCh6 / band12.ExgCh6 > AlphaThresholdRising) && (band10.ExgCh7 / band12.ExgCh7 > AlphaThresholdRising))
                            {
